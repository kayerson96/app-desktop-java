...
import com.mystore.app_store.servicioApi.apiEliminarProduct;
...
public class PageProduct extends javax.swing.JPanel {
   ...
   ApiProducto api = new ApiProducto();
    ...
    private void initComponents() {
        ...
        priceAdd.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                priceAddMouseClicked(evt);
            }
        });
        ...
        imageAdd.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                imageAddMouseClicked(evt);
            }
        });
        ...
        idProduct.setText("Id del producto");
        idProduct.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                idProductMouseClicked(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(27, 27, 27)
                        .addComponent(idProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(155, 155, 155)
    ...
    private void idProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_idProductMouseClicked
        idProduct.setText("");
    }//GEN-LAST:event_idProductMouseClicked

    private void register1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_register1MouseClicked
      
        apiEliminarProduct  apiEliminarProduct = new apiEliminarProduct();
        ...
        int resultado = JOptionPane.showOptionDialog(
                ...
                System.out.println("seleciono yes");
                apiEliminarProduct.eliminarProduct(id);
    ...
    Lista.setModel(model);
                ...
                System.out.println("seleciono que no");}
        
    }//GEN-LAST:event_register1MouseClicked

    private void priceAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_priceAddMouseClicked
        priceAdd.setText("");
    }//GEN-LAST:event_priceAddMouseClicked

    private void imageAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imageAddMouseClicked
        imageAdd.setText("");
    }//GEN-LAST:event_imageAddMouseClicked
